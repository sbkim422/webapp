...
var mongoServer = new mongodb.Server('172.16.75.68',27017);
var dbHandle = new mongodb.Db('spa', mongoServer, {safe : true});
var validator = JSV.createEnvironment();
var objTypeMap = { 'user': {} };

var loadSchema = function (schema_name, schema_path){
	fsHandle.readFile(schema_path, 'utf8', function(err, data){
		objTypeMap[schema_name] = JSON.parse(data);
	});
};

var checkSchema = function(obj_type, obj_map, callback){
